...
function ConferenceSingle({ conference }: ConferenceSingleProps): ReactElement {
  return (
    <article className="bg-white border rounded p-3">
      ...
      <p>
        ...
        nec elit in ultrices. Maecenas nunc sapien, maximus et rhoncus eu,
        lacinia ut purus. Nulla nec tempor velit, et suscipit augue. Vestibulum
        blandit luctus ex. Etiam hendrerit lectus vel volutpat dictum. Aliquam
        bibendum cursus luctus. Duis eleifend ut sapien quis malesuada.
        Suspendisse posuere egestas malesuada. Nam turpis elit, imperdiet ac
        vestibulum eget, ornare vel ligula. Vivamus tempor, sapien eget rutrum
        gravida, sem quam pretium ligula, a efficitur elit neque quis turpis.
      </p>
    </article>
  )
}
